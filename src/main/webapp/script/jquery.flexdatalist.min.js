...
r&&(e.removeClass("flexdatalist-set").attr("style",null).val(a&&a.originalValue&&!t?a.originalValue:"").removeData("flexdatalist").removeData("aliascontainer"),r.remove())
})};
if("string"==typeof e&&"reset"!==e){
if("undefined"!=typeof this[0].fvalue){
var a=this[0];
if("destroy"===e)i(this,t);else if("value"===e){
if("undefined"==typeof t)return a.fvalue.get();a.fvalue.set(t)}
else if("add"===e){
if("undefined"==typeof t)return a.debug("Missing value to add!");
a.fvalue.add(t)}else if("toggle"===e){
