	...
	<div id="bodyContainer">
		...
		<div id="bodyLeft">
			<input type="radio" class="radio" name="progress" value="five"
				...
				name="progress" value="fifty" id="fifty"> <label for="fifty"
				class="label">50%</label> <input type="radio" class="radio"
				name="progress" value="seventyfive" id="seventyfive"> <label
				for="seventyfive" class="label">75%</label> <input type="radio"
				class="radio" name="progress" value="onehundred" id="onehundred">
			...
			<div id="searchbar">
				...
				<form action="" method="Post">
					<input class="champ" type="search" name="recherche"
						list="listLocation" autocomplete="off"
						placeholder="Choisir votre ville" required><input
						type="reset" value="Effacer" id="reset" name="reset" />
					<datalist id="listLocation">
						<c:forEach var="nomDeLaVille" items="${locations}">
							<option value="${nomDeLaVille}" /></option>
						</c:forEach>
					</datalist>
			...
			<figure class="description">
				...
				<figcaption>
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In
						blandit tincidunt orci tempor gravida. Nulla ac lectus ut metus
						tempor imperdiet. Fusce maximus dignissim neque, ut placerat nisl
						pellentesque ac. Suspendisse volutpat at massa quis malesuada.
						Cras sed pulvinar erat, et aliquam nisi. Proin vitae est velit.</p>
			...
			<aside>
				<div class="artwork">
					...
					<div id="zonehistorique">
						<class="crop"> <a href="eventdetailBefore.html" /></a> <img
							id="img5" onclick="affiche(this)" src="" alt="description"
							title="event 1"></class>
						<class="crop"> <a href="eventdetailBefore.html" /></a> <img
							id="img5" onclick="affiche(this)" src="" alt="description"
							title="event 2"></class>
